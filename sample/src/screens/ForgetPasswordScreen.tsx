...
//     // setResendButtonDisabled(true); // Disable resend button
//     // Simulate sending OTP (you may replace this with actual logic)
//     // setTimeout(() => {
//     //   console.log(`OTP sent to ${email}`);
//     //   setCurrentStep('otp'); // Move to OTP input section
//     //   setEmail('');
//     // }, 1000);
//   };
...
//             <Text style={[{ color:mediumGray, paddingVertical: spacings.small }]}>Enter your email for the verification process.We will send 4 digits code to your email.</Text>
...
//             <Text style={{ color: mediumGray, paddingVertical: spacings.small }}>Enter 4 digit code that you received on your email
...
//           text={"Your can now use your new password to login to your account."}
